...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'nerdeez_server_app_file', 'hw_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['nerdeez_server_app.Hw']))

    def backwards(self, orm):

        # Changing field 'File.hw'
        db.alter_column(u'nerdeez_server_app_file', 'hw_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['nerdeez_server_app.Hw']))
    ...
    models = {
        ...
        u'nerdeez_server_app.forgotpass': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 6, 0, 0)'}),
            'hash': ('django.db.models.fields.CharField', [], {'default': "'DnOuqZODImX4DkKT4kNJFSTlpRPic81gy7Zlar1494kZAUoLJy2PHXYtSwsEXm6S'", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
