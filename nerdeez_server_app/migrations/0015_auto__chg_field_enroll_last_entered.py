...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Enroll.last_entered'
        db.alter_column(u'nerdeez_server_app_enroll', 'last_entered', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Enroll.last_entered'
        db.alter_column(u'nerdeez_server_app_enroll', 'last_entered', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        u'nerdeez_server_app.enroll': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_entered': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 5, 0, 0)'}),
        ...
        u'nerdeez_server_app.forgotpass': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 5, 0, 0)'}),
            'hash': ('django.db.models.fields.CharField', [], {'default': "'DJ2Jh7UssA1gJKDqfZdaH2LvkLkLeWIJUciWkYr3N6RwJ4Mdvhu5LofGnkcyu72Y'", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 5, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
