...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Hw', fields ['school_group', 'title']
        db.delete_unique(u'nerdeez_server_app_hw', ['school_group_id', 'title'])

        # Adding field 'File.size'
        db.add_column(u'nerdeez_server_app_file', 'size',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding unique constraint on 'Hw', fields ['school_group', 'title']
        db.create_unique(u'nerdeez_server_app_hw', ['school_group_id', 'title'])

        # Deleting field 'File.size'
        db.delete_column(u'nerdeez_server_app_file', 'size')
    ...
    models = {
        ...
        u'nerdeez_server_app.forgotpass': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 6, 0, 0)'}),
            'hash': ('django.db.models.fields.CharField', [], {'default': "'cytYUIQeC7I8kv2AL81FF8GZMiqIyHxrLJFJoWgWyAdsHNr63LJJXO6svZ171OFn'", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
