...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'File.hash'
        db.add_column(u'nerdeez_server_app_file', 'hash',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'File.hash'
        db.delete_column(u'nerdeez_server_app_file', 'hash')
    ...
    models = {
        ...
        u'nerdeez_server_app.forgotpass': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 6, 0, 0)'}),
            'hash': ('django.db.models.fields.CharField', [], {'default': "'J1cxONoS13jc5sbtWXMFJQUECrqLdIem84IYQjaBe5UsK4IdSQiG6oJhN6xeODJX'", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
