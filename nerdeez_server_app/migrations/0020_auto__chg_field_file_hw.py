...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'File.hw'
        db.alter_column(u'nerdeez_server_app_file', 'hw_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nerdeez_server_app.Hw']))

    def backwards(self, orm):

        # Changing field 'File.hw'
        db.alter_column(u'nerdeez_server_app_file', 'hw_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nerdeez_server_app.SchoolGroup']))
    ...
    models = {
        ...
        u'nerdeez_server_app.file': {
            ...
            'hw': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'files'", 'to': u"orm['nerdeez_server_app.Hw']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'nerdeez_server_app.forgotpass': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 6, 0, 0)'}),
            'hash': ('django.db.models.fields.CharField', [], {'default': "'lGCUlwz2pae7upDt9KhGjlcgMrgkVydbKWr8OvVUge3eJ6vMyfQbUqqVJH33G3MR'", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
