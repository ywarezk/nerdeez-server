...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'File'
        db.create_table(u'nerdeez_server_app_file', (
            ...
            ('hw', self.gf('django.db.models.fields.related.ForeignKey')(related_name='files', to=orm['nerdeez_server_app.SchoolGroup'])),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'nerdeez_server_app', ['File'])

        # Adding unique constraint on 'File', fields ['title', 'hw']
        db.create_unique(u'nerdeez_server_app_file', ['title', 'hw_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'File', fields ['title', 'hw']
        db.delete_unique(u'nerdeez_server_app_file', ['title', 'hw_id'])

        # Deleting model 'File'
        db.delete_table(u'nerdeez_server_app_file')
    ...
    models = {
        ...
        u'nerdeez_server_app.file': {
            ...
            'hw': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'files'", 'to': u"orm['nerdeez_server_app.SchoolGroup']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'nerdeez_server_app.forgotpass': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 6, 0, 0)'}),
            'hash': ('django.db.models.fields.CharField', [], {'default': "'5CAc5BxGluVlprEf5MKUvV5Utg7ZSUebseaDP3kA2AWmwlJghZl3d5pbu4qvRERD'", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
