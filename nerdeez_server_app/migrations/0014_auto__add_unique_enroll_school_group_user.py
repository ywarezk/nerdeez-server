...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Enroll', fields ['school_group', 'user']
        db.create_unique(u'nerdeez_server_app_enroll', ['school_group_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Enroll', fields ['school_group', 'user']
        db.delete_unique(u'nerdeez_server_app_enroll', ['school_group_id', 'user_id'])
    ...
    models = {
        ...
        u'nerdeez_server_app.enroll': {
            'Meta': {'unique_together': "(('user', 'school_group'),)", 'object_name': 'Enroll'},
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_entered': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 5, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 5, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'nerdeez_server_app.forgotpass': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 5, 0, 0)'}),
            'hash': ('django.db.models.fields.CharField', [], {'default': "'gRXIJZ1FqmZ3G7P71ba0DymN7nYUkeBMPJ6NJmdUMsOuqLYK5T4pWuIkztrqFn6F'", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 5, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 5, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['nerdeez_server_app.UserProfile']"})
        },
