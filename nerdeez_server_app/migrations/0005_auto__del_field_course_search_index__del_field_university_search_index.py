...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Course.search_index'
        db.delete_column(u'nerdeez_server_app_course', 'search_index')

        # Deleting field 'University.search_index'
        db.delete_column(u'nerdeez_server_app_university', 'search_index')

        # Deleting field 'Faculty.search_index'
        db.delete_column(u'nerdeez_server_app_faculty', 'search_index')


    def backwards(self, orm):
        # Adding field 'Course.search_index'
        db.add_column(u'nerdeez_server_app_course', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)

        # Adding field 'University.search_index'
        db.add_column(u'nerdeez_server_app_university', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Faculty.search_index'
        db.add_column(u'nerdeez_server_app_faculty', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)
