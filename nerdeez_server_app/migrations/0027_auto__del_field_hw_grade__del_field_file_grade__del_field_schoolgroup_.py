...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Hw.grade'
        db.delete_column(u'nerdeez_server_app_hw', 'grade')

        # Deleting field 'File.grade'
        db.delete_column(u'nerdeez_server_app_file', 'grade')
    ...
    def backwards(self, orm):
        # Adding field 'Hw.grade'
        db.add_column(u'nerdeez_server_app_hw', 'grade',
                      self.gf('django.db.models.fields.DecimalField')(default='3.5', max_digits=3, decimal_places=1),
                      keep_default=False)

        # Adding field 'File.grade'
        db.add_column(u'nerdeez_server_app_file', 'grade',
                      self.gf('django.db.models.fields.DecimalField')(default='3.5', max_digits=3, decimal_places=1),
                      keep_default=False)
    ...
    models = {
        ...
        u'nerdeez_server_app.forgotpass': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 18, 0, 0)'}),
            'dislike': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'hash': ('django.db.models.fields.CharField', [], {'default': "'YU3uAowm47yPyMlH13a5vkqr12B4obMlbbrBmJuks4emnm5u0T3sSXLwAd0FBqTl'", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'like': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 18, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
