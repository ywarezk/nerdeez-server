...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Enroll'
        db.create_table(u'nerdeez_server_app_enroll', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 3, 0, 0))),
            ('modified_data', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 3, 0, 0), auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nerdeez_server_app.UserProfile'])),
            ('school_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nerdeez_server_app.SchoolGroup'])),
        ))
        db.send_create_signal(u'nerdeez_server_app', ['Enroll'])


    def backwards(self, orm):
        # Deleting model 'Enroll'
        db.delete_table(u'nerdeez_server_app_enroll')
    ...
    models = {
        ...
        u'nerdeez_server_app.forgotpass': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 3, 0, 0)'}),
            'hash': ('django.db.models.fields.CharField', [], {'default': "'J87OC2REb5l1QjsQ33Vp3kq6h4VgyxWs10zib6Mzd9LexfrO7IZNa0GwFC2AW3nf'", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 3, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
