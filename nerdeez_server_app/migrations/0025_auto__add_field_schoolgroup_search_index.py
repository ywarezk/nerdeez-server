...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SchoolGroup.search_index'
        db.add_column(u'nerdeez_server_app_schoolgroup', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SchoolGroup.search_index'
        db.delete_column(u'nerdeez_server_app_schoolgroup', 'search_index')
    ...
    models = {
        ...
        u'nerdeez_server_app.forgotpass': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 16, 0, 0)'}),
            'dislike': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'hash': ('django.db.models.fields.CharField', [], {'default': "'IeUiAxFuE1D3Yp9V1235IRsXtfq2UbJp7KpI4tzGUjx4sgz4SGIKWbiQrfeBPaRx'", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'like': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'modified_data': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 16, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
